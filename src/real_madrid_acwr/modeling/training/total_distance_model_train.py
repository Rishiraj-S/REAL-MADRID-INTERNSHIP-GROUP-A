"""
Total Distance — Daily Total Distance Prediction.

Target: total_distance
Pipeline: datapipeline.run_pipeline("total_distance")
...
def main() -> None:
    ...
    print("\n" + "─"*90)
    print(f"Final results (* cv_rmse on log1p scale; train/test metrics in metres)")
    print("─"*90)
